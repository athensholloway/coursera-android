...
public class ActivityLoaderActivity extends Activity {
	...
	private void startExplicitActivation() {
        ...
        this.startActivityForResult(explicitIntent, GET_TEXT_REQUEST_CODE);
	...
	private void startImplicitActivation() {
        ...
        final String title = getResources().getString(R.string.browser_chooser_title);

        Intent chooserIntent = browserIntent.createChooser(browserIntent, title);
    ...
    protected void onReceivedText(final String text){
	...
	protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == GET_TEXT_REQUEST_CODE && resultCode == RESULT_OK){
            onReceivedText(data.getStringExtra("userInput"));
        }
    }
}
